...
# Helper functions
from helpers import blur, greyscale, threshold, morph, canny, quaternion_to_euler, GoToPose
...
class Detection:
    ...
    def get_marker(self, data):
        ...
        if data.markers and not self.positioned:
            ...
            # Get trans and rot of the marker
            listener = tf.TransformListener()
            time.sleep(3)

            (ar_pose, ar_quaternion) = listener.lookupTransform('/map', '/ar_marker_0', rospy.Time(0))
